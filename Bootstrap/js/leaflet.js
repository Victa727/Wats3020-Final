...
var map = L.map('map-container').setView([37.7670193, -122.4217805], 13);

L.control.layers(mapLayers).addTo(map);
satLayer.addTo(map);

var marker = L.marker([37.7670193, -122.4217805]).addTo(map);
marker.bindPopup("<b>Victor's Coffee House</b><br>375 Valencia St, San Francisco, CA 94103, USA");
